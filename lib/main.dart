...
import 'package:dartobra_new/features/auth/presentation/pages/register/onboarding_first/onboarding_first_screen.dart';
import 'package:dartobra_new/features/auth/presentation/pages/splash/splash_screen.dart';
...
void main() async {
  ...
  await CacheService().init(); // abre professionals_cache, vacancies_cache, cache_metadata
