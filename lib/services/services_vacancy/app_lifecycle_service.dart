...
/*
COMO INTEGRAR NO MAIN.DART:

1. Adicione o import:
   import 'package:dartobra_new/services/app_lifecycle_service.dart';

2. No método main() ou no initState() do widget principal, adicione:
...
OU, se preferir inicializar no primeiro widget:
   ...
   class _MyAppState extends State<MyApp> {
     ...
     @override
     void dispose() {
       // Opcional: finaliza o serviço ao fechar o app
...
3. (OPCIONAL) Para forçar uma verificação manual em qualquer lugar do app:

   await AppLifecycleService().checkNow();

OBSERVAÇÕES:
- O serviço verifica automaticamente a cada 6 horas
- A primeira verificação é executada imediatamente após a inicialização
- Vagas e perfis com status "Aberta"/"active" são verificados
- Se expirados, o status muda automaticamente para "Expirada"/"expired"
*/